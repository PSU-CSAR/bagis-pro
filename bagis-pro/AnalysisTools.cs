...
namespace bagis_pro
{
    public class AnalysisTools
    {
            ...
            string sweBufferDistance, string sweBufferUnits)
        {
            ...
            try
            {
                ...
                if (success == BA_ReturnCode.Success)
                {
                    ...
                    success = await GenerateSweZoneLayersAsync(Module1.Current.Aoi.FilePath, 5, dataSourceUnits);
                }
            }
            catch (Exception e)
            {
        ...
        private static async Task<BA_ReturnCode> GenerateSweZoneLayersAsync(string aoiFilePath, int idxDefaultMonth, 
